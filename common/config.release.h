...
inline constexpr auto YANET_CONFIG_BALANCER_SERVICE_REALS_MAX = 100;
inline constexpr std::uint32_t YANET_CONFIG_BALANCER_REAL_WEIGHT_MAX = 100;
static constexpr auto YANET_DEFAULT_BALANCER_REAL_MAPPINGS_LIMIT = 100;
static constexpr auto YANET_DEFAULT_BALANCER_CELLS_PER_WEIGHT_UNIT = 40;
inline constexpr auto YANET_CONFIG_BALANCER_SERVICE_COUNT_MAX = 128;
inline constexpr auto YANET_CONFIG_BALANCER_SERVICE_SIZE = YANET_DEFAULT_BALANCER_CELLS_PER_WEIGHT_UNIT *
                                                           YANET_CONFIG_BALANCER_SERVICE_REALS_MAX *
                                                           YANET_CONFIG_BALANCER_REAL_WEIGHT_MAX;
#define YANET_CONFIG_BALANCER_SERVICES_SIZE (YANET_CONFIG_BALANCER_SERVICE_COUNT_MAX * YANET_CONFIG_BALANCER_SERVICE_SIZE)
